...
let rec right_comb_variant_combination' (i:int) (e:expression) (dst_lmap:_ row_element label_map) (src_kvl:(label * ty_expr row_element) list) : expression list =
...
let rec left_comb_variant_combination' (i:int) (e:expression) (dst_lmap:ty_expr row_element label_map) (src_kvl:(label * ty_expr row_element) list) : expression list =
...
let rec to_right_comb_record
    (prev:expression)
    (l:(label * ty_expr row_element) list)
...
let rec from_right_comb_record
    (prev:expression) 
    (src_lmap:ty_expr row_element label_map)
    (dst_kvl:(label * ty_expr row_element) list)
    (conv_map:expression label_map) : expression label_map =
  match dst_kvl with
