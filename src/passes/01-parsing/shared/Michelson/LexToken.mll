...
let keyword_to_string kwd ?(offsets=true) mode =
...
let kwd_map = mk_map (fun f -> keyword_to_lexeme (f Region.ghost)) kwd_list
...
let data_to_string data ?(offsets=true) mode =
...
let instr_to_string instr ?(offsets=true) mode =
...
let macro_to_string macro ?(offsets=true) mode =
...
let type_to_string type_ ?(offsets=true) mode =
