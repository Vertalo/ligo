...
val annot_to_string :
  annotation -> ?offsets:bool -> [`Byte | `Point] -> string
...
val keyword_to_string :
  keyword -> ?offsets:bool -> [`Byte | `Point] -> string
...
val data_to_string :
  data -> ?offsets:bool -> [`Byte | `Point] -> string
...
val instr_to_string :
  instruction -> ?offsets:bool -> [`Byte | `Point] -> string
...
val macro_to_string :
  macro -> ?offsets:bool -> [`Byte | `Point] -> string
