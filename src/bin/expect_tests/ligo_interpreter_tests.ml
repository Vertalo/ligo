...
let%expect_test _ =
  ...
  [%expect {|
    ...
    val comparison_int = {  ; 0 = (false : bool) ; 1 = (true : bool) ; 2 = (false : bool) ; 3 = (true : bool) }
    val comparison_string = {  ; 0 = (false : bool) ; 1 = (true : bool) }
    ...
    val map_mem = {  ; 0 = (true : bool) ; 1 = (false : bool) }
    ...
    val set_mem = {  ; 0 = (true : bool) ; 1 = (false : bool) ; 2 = (false : bool) }
    val recursion_let_rec_in = 55 : int
    val sum_rec = <rec fun>
    val top_level_recursion = 55 : int
    val timestamp_op = true : bool
  ...
  [%expect {|
    ...
    val main2 = <fun>
    val main_self = <fun>
    val main_create_contract = <fun>
    val assert_failure = true : bool
    val assert_failure_internal = true : bool
    val test1 = true : bool
    val self = true : bool
    val create_contract = true : bool |}]